...
<section class="banner scrollSection">
    <div class="container-custom">
        <div class="row">
            ...
            <div class="bannerBoy">
                <img src="image/Banner_boy.webp" alt="Banner boy">
            </div>

        </div>
        <div class="blinkArea" id="blinkText">
            ...
            <div class="scientificallyBackedYellow">
                <div class="container-custom">
                    <div class="scientificText">
                        ...
                        <h2>Formulas</h2>
                        <p>Proven active ingredients designed to tackle dandruff and care for your scalp.</p>
                    </div>
                </div>
            </div>
            <div class="scientificallyBackedImage">
                <img src="image/scientificallyBacked.webp" alt="Scientifically Backed">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="container-custom">
                    <div class="fastLongLastingText">
                        ...
                        <div class="d-flex text-white">
                            <p>Effective from day 1 and delivers relief that lasts up to 3 months</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="fastLongLastingImage">
                <img src="image/long-lasting.webp" alt="Long lasting">
            </div>
        </div>
    </div>
</section>
<section class="toughOnDandruffButNotOn position-relative scrollSection">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="toughOnDandruffButNotOnImage">
                <img src="image/tough-On-Dandruf-ButNot-On.webp" alt="Your hair">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="owl-carousel owl-theme homeSlider">
                <div class="item">
                    ...
                    <div class="discover d-flex justify-content-center">
                        <button class="sprinkles">Discover</button>
                    </div>
                </div>
                <div class="item">
                    <div class="slider_first">
