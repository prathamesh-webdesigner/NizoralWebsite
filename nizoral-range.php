...
<section class="range_discover position-relative">
    <div class="container">
        <div class="row">
            ...
            <div class="range_drops">
                <img src="image/yellow-drop.webp" alt="drop">
                <img src="image/blue_drop.webp" alt="drop">
                <img src="image/sky_blue_drop.webp" alt="drop">
            </div>
        </div>
    </div>
</section>
<section class="white_part_nizoraal_range bg-white">
    <div class="container">
...
<section class="scintific_baked_formula">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 p-0">
                <div class="scintific_image">
                    <img src="image/scientificallyBacked.webp" alt="scintific_baked_formula">
                </div>
            </div>
        </div>
        ...
        <div class="row d-flex align-items-center">
            <div class="col-md-6 p-0 order-2 order-md-1">
                <div class="scintific_image" style="background-color: #207cde;">
                    <img src="image/long-lasting.webp" alt="scintific_baked_formula" style="transform: scaleX(-1);">
                </div>
            </div>
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6 p-0">
                <div class="scintific_image">
                    <img src="image/tough-On-Dandruf-ButNot-On.webp" alt="scintific_baked_formula">
                </div>
            </div>
        </div>
