...
<section class="banner-shampoo position-relative pb-5">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div class="shampoo_img">
            ...
            <div class="col-md-7">
                <div class="shampoo_text">
                    ...
                    <div class="row four_lists mt-5">
                        <div class="col-md-6">
                            <div class="iconFirst d-flex align-items-center">
                                <div>
...
<section class="stubborn_dandruff_parent position-relative">
    <div class="container-fluid">
        <div class="row stubborn-dandruff-part">
            ...
            <div class="stubborn_dandruff_image">
                <img src="image/tough-On-Dandruf-ButNot-On.webp" alt="stubborn-dandruff">
            </div>
        </div>
        ...
        <div class="row tenX position-relative">
            ...
            <div class="tenX_DNA_img d-none d-md-block">
                <img src="image/shampoo/checmical-2.png" alt="Chemical">
            </div>
        </div>
    </div>
</section>

<section class="white_para">
    <div class="container">
        <div class="row">
...
<section class="product_facts position-relative">
    <div class="container">
        ...
        <div class="row z-9 position-relative">
            ...
            <div class="col-md-6 Text_area">
                <div class="indicatong_group">
                    ...
                    <div class="indication align-items-center">
                        <div>
